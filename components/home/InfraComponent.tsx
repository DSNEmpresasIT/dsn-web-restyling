  ...
  return (
    <section className="py-24 relative overflow-hidden bg-background-dark" id="infraestructura">
      ...
      <div className="max-w-screen-2xl mx-auto px-6 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-7xl uppercase font-semibold bg-gradient-to-r from-[#3B96D1] via-sky-100 to-white bg-clip-text text-transparent mb-6">Capacidad Técnica en Terreno</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-1">
          ...
          <motion.div
            ...
            className="bg-primary p-10 flex flex-col justify-between cursor-pointer rounded-2xl"
          >
            <div>
