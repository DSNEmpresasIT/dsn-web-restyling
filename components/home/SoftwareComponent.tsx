...
export const SoftwareComponent = () => {
  return (
    <section className="py-24 bg-[radial-gradient(ellipse_at_right,_var(--tw-gradient-stops))] from-sky-400/10 to-indigo-900/10" id="software">
            ...
            <div className="p-10">
              <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex gap-2">
                  <span className="px-2 py-1 bg-white/15 border border-white/10 rounded text-[10px] text-slate-200">NESTJS</span>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <span className="text-xs font-semibold px-3 py-1 bg-white/15 rounded-full text-slate-300">Auditoría Real-time</span>
              </div>
            </div>
          </motion.div>
          <motion.div
            ...
            <div className="p-10">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <span className="text-xs font-semibold px-3 py-1 bg-white/15 rounded-full text-slate-300">Identidad Digital</span>
              </div>
            </div>
          </motion.div>
        </div>
